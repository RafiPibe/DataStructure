...
int main(int argc, char const *argv[]) {
    ...
    for(int i = 0; i < a; i++) {
        ...
        if (strcmp(arg0, "KeBelakang") == 0) {
        scanf("%d", &arg1);
        slist_pushBack(&myList, arg1);
        }

        else if(strcmp(arg0, "TaruhDepan") == 0) {
        scanf("%d", &arg1);
        slist_pushFront(&myList, arg1);
        }

        else if(strcmp(arg0, "Urgent") == 0){
            slist_popFront(&myList);
        }

        else if(strcmp(arg0, "GakPenting") == 0){
            slist_popBack(&myList);
        }

        // else if(strcmp(arg0, "Putar") == 0){
        //     printf("%d\n", slist_front(&myList));
